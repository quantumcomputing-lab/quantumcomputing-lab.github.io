...
\providecommand{\publicationEntry}[3]{
  \noindent \textbf{#1}, \textit{#2}, \textit{#3}
  \vspace{0.1ex}
} 
...
\title{Samudra Dasgupta}
\author{+1-865-223-3814 | samudra.dasgupta@gmail.com\\tinyurl.com/quantumfinance2023}
\date{\today}
